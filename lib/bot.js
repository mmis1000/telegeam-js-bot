...
Or run /[you favorite language]_hello to view hello world example
    ...
    if (message.text != undefined && message.text.match(/\/[a-z0-9_]+(@[^\s]+)?/)) {
        ...
        if (!language) return api.sendMessage(message.chat.id, 'something went wrong');
        language = language[1];
            ...
            try {
                ...
                if (cmd.type === 'stdout') {
                    ...
                    while (stdoutBuffer.length > 1333) {
                        ...
                        api.sendMessage(message.chat.id, part);
                    }
                ...
                if (cmd.type === 'stderr') {
                    ...
                    while (stdoutBuffer.length > 1333) {
                        ...
                        api.sendMessage(message.chat.id, "stderr: " + part);
                    }
